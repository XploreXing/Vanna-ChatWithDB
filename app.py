...
st.title("Vanna AI, Chat with Database")
...
if assistant_message_suggested.button("Click to show suggested question"):
            ...
            if st.session_state.get("show_followup", True):
                ...
                if len(followup_questions) > 0:
                    ...
                    for i, question in enumerate(followup_questions[:5]):
                        assistant_message_followup.button(question, 
                        on_click=set_question, 
                        args=(question,),
                        key=f"followup_question_{i}"
                        )
